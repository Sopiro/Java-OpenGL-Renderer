...
public class GameLoop
{
	...
	public void init()
	{
		...
		// lights.add(new PointLight(new Vector3f(50, 10, 50), new Vector3f(0,
		// 0, 5), new Vector3f(1, 0.01f, 0.019f), 200));

		TexturedModel model = new TexturedModel(OBJLoader.loadObjModel(loader, "cube"), loader.brick3);
		TexturedModel model2 = new TexturedModel(OBJLoader.loadObjModel(loader, "cube"), loader.brick);

		e = new Entity(model, new Vector3f(0, 40, 0), new Vector3f(0, 0, 0), 40);
